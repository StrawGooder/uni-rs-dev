...
<view>
	...
	>
		...
		@click="itemToCheck(item.tbbh,item.investigationStatus)"
		>
...
<script>
	...
	export default {
		...
		data() {
			return {
				taskList:[{tbbh:"aa", taskCreateTime:"2023-01-22 12:00:00", investigationStatus:"已核查", commitStatus:"已审核待提交"},
				{tbbh:"bb", taskCreateTime:"2023-01-22 12:00:00", investigationStatus:"已核查", commitStatus:"已审核待提交"},
				]
			}
		},
		onShow() {
